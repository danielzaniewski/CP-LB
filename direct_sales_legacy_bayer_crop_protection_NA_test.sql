...
-- SQ1 (Subquery-1) for Return Quantity
    SQ1 AS (
        SELECT
            'DataOne-PBC' AS SOURCE_SYSTEM_CODE,
            ...
            'SAP-PBC-C' AS OPERATIONAL_ACCOUNT_IDENTIFIER_1_SOURCE_SYSTEM_CODE,
...
,OPL.OPL_ACCOUNT_ID
,OPL.OPL_ACCOUNT_SOURCE_SYSTEM_CODE
...
FROM
    ...
    ON
            ...
            AND TRIM(opl_source_system_code) = 'SAP-PBC-C'